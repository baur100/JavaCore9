...
public class AmexRestaurantGold implements Discounts {
    private String name;
    ...
    public AmexRestaurantGold(String name, double otherPurchaseCost, double gasCost, double restaurantCost, double otherPurchaseDiscount, double gasDiscount, double restaurantDiscount) {
        this.name = name;
    ...
    @Override
    public void info() {
        System.out.println("American Express Restaurant Gold = "+name+
