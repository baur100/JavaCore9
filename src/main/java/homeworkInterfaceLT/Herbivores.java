...
public abstract class Herbivores extends Mammals {
    public Herbivores(String name, String scientificName, String lifeSpan, String procreation, String diet, String size, String habitat, String population, String numberOfOffSpring) {
