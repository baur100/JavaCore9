...
public abstract  class Rodents extends Mammals {
    public Rodents(String name, String scientificName, String lifeSpan, String procreation, String diet, String size, String habitat, String population, String numberOfOffSpring) {
